...
import CallToActiondq3 from "./components/CallToActiondq3";
...
export default function Chatbot() {
  ...
  useEffect(() => {
    const initialMessages = [
      ...
      {
        text: "Emily this side. Let’s find out if you qualify for the Spending Allowance worth $186/month — it’s quick and only takes 2 minutes!",
        sender: "bot",
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 p-4 space-y-2 overflow-y-auto flex flex-col mt-[1%] pb-52">
        ...
        {finalMessage && <CallToActiondq3 finalMessage={finalMessage} switchNumber={switchNumber}/>}
